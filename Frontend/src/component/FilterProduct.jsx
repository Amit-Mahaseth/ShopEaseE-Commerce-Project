...
const FilterProduct = ({ filters, setfilters }) => {
  ...
  return (
    <div className="flex flex-col w-full p-2">
        ...
        <select
          className="border-0 mb-2 bg-gray-200 w-full text-black shadow-lg rounded-lg px-3 py-1"
        ...
        <h1>Price</h1>
        <select
          className="border-0 mb-2 bg-gray-200 text-black shadow-lg rounded-lg px-3 py-1"
          value={filters.price}
